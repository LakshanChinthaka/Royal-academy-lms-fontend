      ...
      <ul class="flex bg-gray-800 p-1.5 font-sans py-4">
        {StudentNavBarItems.map((item) => (
          <li key={item.path} className="w-full `">
            <Link
              to={item.path}
              className={`text-white rounded-md gap-2 md:ml-[200px]  md:text-center font-bold  text-base px-2 cursor-pointer whitespace-nowrap ${location.pathname === item.path
