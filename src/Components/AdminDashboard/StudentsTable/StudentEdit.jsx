...
function StudentEdit() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(STUDENT_UPDATE_URL, payload, {
        headers: {
  ...
  return (
    <div>
      <Grid container>
        <Grid item xs={4}>
          <h2 class="inline-block text-xl justify-items-center ml-[100px] mt-2  font-bold text-gray-700">
            Edit Student
          </h2>
        </Grid>
        <Grid item xs={4}></Grid>
                  ...
                  <div class="grid sm:grid-cols-2 gap-y-7 gap-x-12">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        name="mobileNo"
                        pattern="[0-9]*"
                        type="number" // Change type to "text" for a text input
