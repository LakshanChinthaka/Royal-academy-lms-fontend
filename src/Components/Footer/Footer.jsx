...
function Footer() {
  return (
    <div className='content-between max-h-screen'>
      <footer class="bg-gray-900 py-10 px-8 font-[sans-serif]">
      <div class="flex max-lg:flex-col items-center justify-between gap-6 text-center">
        <ul class="flex space-x-6">
          <li>
            <a href="javascript:void(0)">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="fill-gray-300 inline hover:fill-white w-7 h-7"
                viewBox="0 0 24 24">
        ...
        <p class='text-base text-gray-300'>Copyright © 2023<a href='https://readymadeui.com/' target='_blank'
