      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12 max-md:max-w-lg mx-auto">
          <div class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <p class="text-gray-300 group-hover:text-gray-500 text-sm">Tailor our product to suit your needs.</p>
          </div>
          <div class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
          ...
          <div class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <p class="text-gray-300 group-hover:text-gray-500 text-sm">24/7 customer support for all your inquiries.</p>
          </div>
          <div class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
