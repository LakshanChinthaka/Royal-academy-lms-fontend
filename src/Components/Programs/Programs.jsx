...
import Business_img from "../../assets/business_management.jpg"
import { Link } from 'react-router-dom'

function Courses() {
  return (
    <div>
      <div class="font-[sans-serif] mb-11">
      <div class="p-4 mx-auto lg:max-w-6xl md:max-w-4xl sm:max-w-full">
        <h2 class="text-4xl font-extrabold text-gray-800 mt-5 mb-12">Available Programs</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Link to={"/course"}>
            <div class="w-full aspect-w-16 aspect-h-8 lg:h-80">
              <img src={Business_img} alt="Product 1" class="h-full w-full object-cover object-top" />
            </div>       
            <div  class="p-6">
              <h3 class="text-lg font-bold text-gray-800">Msc. Business Management</h3>
              <p class="text-sm text-gray-700">University of Colombo</p>
              <div class="mt-1 flex items-center flex-wrap gap-2">
                <p class="text-base text-gray-700">Rs. 450,000</p>
              </div>              
            </div>
            </Link>
          </div>
          <div class="bg-white rounded-md overflow-hidden shadow-md cursor-pointer hover:scale-[1.02] transition-all">
            ...
            <div class="p-6">
              <h3 class="text-lg font-bold text-gray-800">Diploma. Networking</h3>
              <p class="text-sm text-gray-700">London Met University </p>
              <div class="mt-1 flex items-center flex-wrap gap-2">
                <p class="text-base text-gray-700">Rs.27,000</p>
